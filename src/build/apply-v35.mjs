...
if (!electron.includes('from "./mac-native-main.js"')) {
  electron = replaceRequired(electron, electronImport, `${electronImport}\nimport { session } from "electron";\nimport crypto from "node:crypto";\nimport { installMacNativeMain, macNativePreloadPath, openMacSettings } from "./mac-native-main.js";`, "native imports");
}
...
if (!electron.includes("skytrace_desktop")) {
...
pkg.scripts.check = `${pkg.scripts.check || "node scripts/check-runtime.mjs"} && node --check mac-native-main.js && node --check mac-native-preload.cjs && node --check mac-native-renderer.js && node --check mac-settings.js && node --check mac-detached.js`;

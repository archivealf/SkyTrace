...
requireText(webIndex, "/app/web-mobile.css?v=34.4", "versioned mobile proportion stylesheet");
requireText(webIndex, "/app/web-mobile-interactions.css?v=34.4", "versioned iPhone interaction stylesheet");
requireText(webIndex, "/app/web-mobile.js?v=34.4", "versioned iPhone interaction runtime");
...
requireText(sw, 'const CACHE = "skytrace-web-v34-4"', "versioned PWA cache");
requireText(sw, '"/app/web-mobile.css?v=34.4"', "cached mobile proportion stylesheet");
requireText(sw, '"/app/web-mobile-interactions.css?v=34.4"', "cached iPhone interaction stylesheet");
requireText(sw, '"/app/web-mobile.js?v=34.4"', "cached iPhone interaction runtime");
...
console.log(`SkyTrace platform support verified: Windows x64 desktop + proportion-correct, draggable iPhone/iPad PWA${materialized ? " (materialized build)" : " (source tree)"}.`);

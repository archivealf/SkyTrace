...
requireText(webIndex, "/app/web-mobile.css?v=34.5", "versioned mobile proportion stylesheet");
requireText(webIndex, "/app/web-mobile-interactions.css?v=34.5", "versioned iPhone interaction stylesheet");
requireText(webIndex, "/app/web.js?v=34.5", "versioned live traffic runtime");
requireText(webIndex, "/app/web-mobile.js?v=34.5", "versioned iPhone interaction runtime");
...
requireText(mobileInteractionsCss, "height:auto!important", "map must not use VisualViewport height");
...
requireText(mobileJs, "dragDistance < -34", "upward expand threshold");
...
requireText(sw, 'const CACHE = "skytrace-web-v34-5"', "versioned PWA cache");
requireText(sw, '"/app/web-mobile.css?v=34.5"', "cached mobile proportion stylesheet");
requireText(sw, '"/app/web-mobile-interactions.css?v=34.5"', "cached iPhone interaction stylesheet");
requireText(sw, '"/app/web.js?v=34.5"', "cached live traffic runtime");
requireText(sw, '"/app/web-mobile.js?v=34.5"', "cached iPhone interaction runtime");
...
console.log(`SkyTrace platform support verified: Windows x64 desktop + draggable iPhone/iPad PWA with full-viewport map and stable live traffic refresh${materialized ? " (materialized build)" : " (source tree)"}.`);

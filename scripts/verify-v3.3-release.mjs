...
if (process.env.SKYTRACE_COMMERCE_URL) {
  ...
  const runtimeFiles = ["app.v3.js","v3.3-codes.js","v3.3-platform.js","v3.3-export-fix.js","server.js","electron-main.js","lib/config.js","lib/account.js","lib/live.js","lib/aircraft.js","lib/weather.js","lib/precipitation.js","api/config.js","api/health.js"];
...
console.log(`Verified SkyTrace ${BUILD}: identity, packaging, performance, redeem codes, Cloud tools and free commercial provider stack are consistent.`);
